...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '4b7afc8f8ee01bb1173a985019ff3d49',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'React material full <app@flatlogic.app>',
    host: 'email-smtp.us-east-1.amazonaws.com',
    port: 587,
    auth: {
      user: 'AKIAVEW7G4PQUBGM52OF',
      pass: 'BLnD4hKGb6YkSz3gaQrf8fnyLi3C3/EdjOOsLEDTDPTz',
    },
    tls: {
  ...
  project_uuid: 'd599a8a9-4253-4eb7-9b48-c6f9131c5623',
  flHost:
